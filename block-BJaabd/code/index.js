...
let numbOne = +prompt('enter your first number');
let numbTwo = +prompt('enter your second number');
let numThree = +prompt('enter the third number');

let product = numbOne * numbTwo * numThree;
...
switch (operation) {
  ...
  case 'Sub':
    alert(
      `The subtraction of ${firstNum} and ${secondNum} is ${
        firstNum - secondNum
      }`
    );
    break;
  case 'Mul':
    alert(
      `The product of ${firstNum} and ${secondNum} is ${firstNum * secondNum}`
    );
    break;
  case 'Div':
    alert(
